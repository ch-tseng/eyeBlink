...
video_in = "/media/sf_ShareFolder/blink.mp4"
...
while True:
    ...
    line1 = "Left:"+str(round(leftEAR,2)) + "   Right:"+str(round(rightEAR,2))

    frameBG[0:height, bgDark_w:width+bgDark_w] = frame
    frameBG = putText(frameBG, line1, 20, 50, (0,255,0), 2, 1.2)
    ...
    frameBG[120:120+img_left.shape[0], 90:90+img_left.shape[1]] = img_left
    frameBG[120:120+img_right.shape[0], 300:300+img_right.shape[1]] = img_right
